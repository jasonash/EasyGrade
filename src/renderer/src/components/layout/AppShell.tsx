...
import { activeNavItem, useUiStore, type NavPage } from '@/stores/ui.store'
...
export function AppShell({ children }: { children: ReactNode }): JSX.Element {
  ...
  useEffect(() => {
    ...
    void loadBatches().catch((err: unknown) => toast('error', describeError(err)))
